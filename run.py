...
os.chdir('/content/QUFETI-Virtual-Trial-Room')
os.system("rm -rf /content/inputs/test/cloth/.ipynb_checkpoints")
os.system("python cloth-mask.py")
os.chdir('/content')
os.system("python /content/QUFETI-Virtual-Trial-Room/remove_bg.py")
os.system(
...
# making predictions
os.system(
    "python /content/QUFETI-Virtual-Trial-Room/test.py --name output --dataset_dir /content/inputs --checkpoint_dir /content/QUFETI-Virtual-Trial-Room/checkpoints --save_dir /content/")
